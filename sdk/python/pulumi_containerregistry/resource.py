...
class ResourceArgs:
    def __init__(__self__, *,
                 ...
                 remote_tag: pulumi.Input[builtins.str],
                 image_tarball_hash: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Resource resource.
        :param pulumi.Input[Union[pulumi.Asset, pulumi.Archive]] image: Image tarball thing.
        :param pulumi.Input[builtins.str] remote_tag: The tag to save the image to.
        :param pulumi.Input[builtins.str] image_tarball_hash: Hash of the image tarball.
        """
    ...
    def remote_tag(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @remote_tag.setter
    def remote_tag(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "remote_tag", value)

    @property
    @pulumi.getter(name="imageTarballHash")
    def image_tarball_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def image_tarball_hash(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ResourceState:
    def __init__(__self__, *,
                 ...
                 image_tarball_hash: Optional[pulumi.Input[builtins.str]] = None,
                 remote_tag: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="remoteTag")
    def remote_tag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The tag to save the image to.
        """
        return pulumi.get(self, "remote_tag")
    ...
    @remote_tag.setter
    def remote_tag(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_tag", value)
...
class Resource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            image: Optional[pulumi.Input[Union[pulumi.Asset, pulumi.Archive]]] = None,
            image_tarball_hash: Optional[pulumi.Input[builtins.str]] = None,
            remote_tag: Optional[pulumi.Input[builtins.str]] = None) -> 'Resource':
        """
    ...
    @property
    @pulumi.getter(name="imageTarballHash")
    def image_tarball_hash(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Hash of the image tarball.
        """
        return pulumi.get(self, "image_tarball_hash")
    ...
    @property
    @pulumi.getter(name="remoteTag")
    def remote_tag(self) -> pulumi.Output[builtins.str]:
        """
        The tag to save the image to.
        """
        return pulumi.get(self, "remote_tag")
