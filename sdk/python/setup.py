    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource containerregistry {PLUGIN_VERSION}`
                """)
            else:
                raise
...
def readme():
    try:
        ...
        return "containerregistry Pulumi Package - Development Version"


setup(name='pulumi_containerregistry',
      python_requires='>=3.7',
      version=VERSION,
