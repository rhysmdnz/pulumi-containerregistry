...
const (
	...
	mainPkg = "containerregistry"
	// modules:
	mainMod = "index" // the containerregistry module
)

//go:embed cmd/pulumi-resource-containerregistry/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-containerregistry/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-containerregistry/main.go, replace the
		...
		// convention is to have a function at "github.com/rhysmdnz/terraform-provider-containerregistry/provider".New
		...
		Keywords:   []string{"containerregistry", "category/cloud"},
		License:    "Apache-2.0",
		...
		Config:       map[string]*tfbridge.SchemaInfo{
			...
			// "region": {
			// 	Type: "containerregistry:region/region:Region",
			// },
		},
		// If extra types are needed for configuration, they can be added here.
		ExtraTypes: map[string]schema.ComplexTypeSpec{
			// "containerregistry:region/region:Region": {
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/rhysmdnz/pulumi-containerregistry/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("containerregistry_", mainMod,
